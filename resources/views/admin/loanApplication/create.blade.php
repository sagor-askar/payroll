        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="{{ route("admin.loan.store") }}" method="POST" enctype="multiple/form-data">
                        @csrf
                        <div class="row">
...
<script type="text/javascript">
    $(document).ready(function () {
        $(document).on('change', '#employee_id', function () {
            ...
            $.ajax({
                type: 'get',
                url: '{{ route("admin.get_employee.loanhistory") }}',
                data: {'id': id},
                dataType: "json",
                success: function (data) {
                    if(data.loan_amount > 0.00 ){
                        statusMsg = 'Opps ! Loan Amount Still Unpaid. Please Pay Fast.' ;
