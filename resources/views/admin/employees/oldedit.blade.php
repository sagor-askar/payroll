            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.employees.update", [$employee->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="first_name" id="first_name" value="{{ old('first_name', $employee->first_name) }}" required>
                                    ...
                                    <div class="form-group {{ $errors->has('last_name') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="last_name" id="last_name" value="{{ old('last_name', $employee->last_name) }}" required>
                                    ...
                                    <div class="form-group {{ $errors->has('father_name') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="father_name" id="father_name" value="{{ old('father_name', $employee->father_name) }}" required>
                                    ...
                                    <div class="form-group {{ $errors->has('mother_name') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="mother_name" id="mother_name" value="{{ old('mother_name', $employee->mother_name) }}" required>
                                    ...
                                    <div class="form-group {{ $errors->has('address') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="address" id="address" value="{{ old('address', $employee->address) }}" required>
                                    ...
                                    <div class="form-group {{ $errors->has('contact_no') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="contact_no" id="contact_no" value="{{ old('contact_no', $employee->contact_no) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-check-input" type="radio" onclick="spouseDivShow()" name="marital_status" value="1" id="flexRadioDefault2" {{$employee->marital_status == 1 ? 'checked': ' '}}>Yes
                                    <input class="form-check-input" type="radio" onclick="spouseDivHidden()" name="marital_status" value="0" id="flexRadioDefault2" {{$employee->marital_status == 0 ? 'checked': ' '}}>No
                                    <br><br>

                                    <div id="myDIV" style="display:none">
                                        <div class="form-group {{ $errors->has('spouse') ? 'has-error' : '' }}">
                                            <label for="contact_no">{{ trans('cruds.employee.fields.spouse') }}</label>
                                            <input class="form-control" type="text" name="spouse" id="spouse" value="{{ old('spouse',  $employee->spouse) }}">
                                        ...
                                        <div class="form-group {{ $errors->has('spouse_contact_no') ? 'has-error' : '' }}">
                                            ...
                                            <input class="form-control" type="text" name="spouse_contact_no" id="spouse_contact_no" value="{{ old('spouse_contact_no', $employee->spouse_contact_no) }}">
                                    ...
                                    <div style="margin-top: 6px" class="form-group {{ $errors->has('emergency_contact_no') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="emergency_contact_no" id="emergency_contact_no" value="{{ old('emergency_contact_no', $employee->emergency_contact_no) }}">
                                    ...
                                    <div class="form-group {{ $errors->has('emergency_address') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="emergency_address" id="emergency_address" value="{{ old('emergency_address', $employee->emergency_address) }}">
                                    ...
                                    <div class="form-group {{ $errors->has('nid_no') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="nid_no" id="nid_no" value="{{ old('nid_no', $employee->nid_no) }}">
                                    ...
                                    <div class="form-group {{ $errors->has('passport_no') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="passport_no" id="passport_no" value="{{ old('passport_no',$employee->passport_no) }}">
                                    ...
                                    <div class="form-group {{ $errors->has('blood_group') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="blood_group" id="blood_group" value="{{ old('blood_group', $employee->blood_group) }}">
                        ...
                        <fieldset>
                            <h2 class="title">Update Positional Info</h2>
                           <div class="row">
                               <div class="col-md-6">
                                   <div class="form-group {{ $errors->has('employee_device_id') ? 'has-error' : '' }}">
                                       ...
                                       <input class="form-control" type="number" name="employee_device_id" id="employee_device_id" value="{{ old('employee_device_id', $employee->employee_device_id) }}">
                                   ...
                                   <div class="form-group">
                                       ...
                                       <select class="form-control select3"  id="sub_com_id">
                                           ...
                                           @foreach($sub_companies as $id => $sub_company)
                                               <option selected value="{{ $sub_company->id }}">{{ $sub_company->sub_company_name }}</option>
                                           @endforeach
                                       </select>
                                   </div>
                               ...
                               <div class="col-md-6">
                                   <div class="form-group {{ $errors->has('employee_assign_to_id') ? 'has-error' : '' }}">
                                       <label  for="employee_assign_to_id">{{ trans('cruds.employee.fields.employee_assign_to_id') }}</label>
                                   ...
                                   <div class="form-group {{ $errors->has('joining_date') ? 'has-error' : '' }}">
                                       ...
                                       <input class="form-control date" type="text" name="joining_date" id="joining_date" value="{{ old('joining_date', $employee->joining_date) }}" required>
                                   ...
                                   <div>
                                       <label for="music">Is Attendance ?</label>
                                       <br>
                        ...
                        <fieldset>
                            <h2 class="title">Update Bank Info</h2>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('account_holder_name') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="account_holder_name" id="account_holder_name" value="{{ old('account_holder_name', $employee->account_holder_name) }}">
                                    ...
                                    <div class="form-group {{ $errors->has('account_number') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="account_number" id="account_number" value="{{ old('account_number', $employee->account_number) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('bank_name') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $employee->bank_name) }}">
                                    ...
                                    <div class="form-group {{ $errors->has('branch_name') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="branch_name" id="branch_name" value="{{ old('branch_name', $employee->branch_name) }}">
                        ...
                        <fieldset>
                            <h2 class="title">Update Documents</h2>
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <fieldset>
                            <h2 class="title">Update Educational Setup</h2>
                            <div class="row">
                                <div>
                                    ...
                                    <div class="employee_records">
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="examination[]" id="examination" value="{{ old('examination',$result->examination) }}" placeholder="Examination">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <label class="required" for="institute">{{ trans('cruds.education.fields.institute') }}</label>
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="institute[]" id="institute" value="{{ old('institute', $result->institue) }}" placeholder="Institute">
                                            </div>
                                        </div>
                                        <div class="col-md-2 " >
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="form-group">
                                                <input class="form-control" type="text" name="result[]" id="result" value="{{ old('result', $result->result) }}" placeholder="Result">
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('salary') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="salary" id="salary" value="{{ old('salary', $employee->salary) }}"  required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('tax') ? 'has-error' : '' }}">
                                        ...
                                        <input class="form-control" type="text" name="tax" id="tax" value="{{ old('tax', $employee->tax) }}">
                                        @if($errors->has('tax'))
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $(document).on('change', '#sub_com_id', function () {
                ...
                $.ajax({
                    type: 'get',
                    url: '{{ route("admin.get_employee.department_edit") }}',
                    data: {'id': id},
                    dataType: "json",
...
@if(isset($employee) && $employee->certificates)
          var files =
            {!! json_encode($employee->certificates) !!}
              for (var i in files) {
              var file = files[i]
