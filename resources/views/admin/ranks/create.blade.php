        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.rank.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.ranks.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('rank') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" placeholder="Enter Rank Name" type="text" name="rank" id="rank" value="{{ old('rank', '') }}" required>
                                @if($errors->has('rank'))
