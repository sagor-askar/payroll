        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading" style="height: 53px;">
                    ...
                    <a style="float: right" type="button" class="btn btn-primary" href="{{ route('admin.payroll.salary-chart-pdf', $date) }}" target="_blank">Print Information <i class="fa fa-print" title="Print From Here"></i></a><hr>
                </div>
                            ...
                            <tbody>
                                @foreach($salaryChart as $key => $chart)
                                    ...
                                    <tr data-entry-id="{{ $chart->id }}">
                                        ...
                                        <td>
                                            {{ $chart->pf_loan_amount }}
                                        </td>
                                        <td>
                                            {{ $chart->advance_amount }}
                                        </td>
                                        <td>
                                            {{ $chart->deduction_amount }}
                                        </td>
                                        <td>
                                            {{ $chart->late_deduction_amount }}
                                        </td>
                                        <td>
                                            {{ $chart->total_deduction }}
                                        </td>
                                        <td>
                                            {{ $chart->net_salary }}
                                        </td>
