                    ...
                    <form method="POST" action="{{ route("admin.sub-companies.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->has('sub_company_name') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" placeholder="Enter Name" name="sub_company_name" id="sub_company_name" value="{{ old('sub_company_name', '') }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('sub_company_address') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" placeholder="Enter Address" type="text" name="sub_company_address" id="sub_company_address" value="{{ old('sub_company_address', '') }}" required>
                            ...
                            <div class="form-group {{ $errors->has('contact_no') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" placeholder="Enter Contact No." type="number" name="contact_no" id="contact_no" value="{{ old('contact_no', '') }}">
