                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p
                                        ...
                                        Subject: Invitation to Interview for {{$job_title}} Role at Polock Group.</p>
                                    <p
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Dear {{$name}}, </p>
                                    ...
                                    <p
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Thank you for your application for the {{$job_title}} role at Polock Group. We are pleased to inform you that you have been
                                        shortlisted for an interview.
                                    </p>

                                    <p
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        The interview will take place on {{$interview_date}} at {{$interview_time}} at our office located at {{$company_address}}.
                                        Please arrive at least 10 minutes prior to your scheduled interview time.
                                    </p>

                                    <p
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        During the interview, you will have the opportunity to meet with our team and discuss your qualifications, experience, and suitability for the role.

                                    </p>

                                    <p
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Please bring a copy of your resume and any other relevant documents that you would like to share with
                                        us.
                                    </p>

                                    <p
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        If the scheduled interview date and time are not convenient for you, please
                                        let us know, and we will try our best to arrange an alternative time that
                                        works for you.
                                    </p>

                                    <p
                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        We are excited to learn more about you and your interest in the {{$job_title}} role at {{$company_title}}.
                                        Please let us know if you have any questions or concerns before the interview. <br>
