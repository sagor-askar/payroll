                    ...
                    <form method="POST" action="{{ route("admin.branches.store") }}" enctype="multipart/form-data">
                       ...
                       <div class="col-md-6">
                            <div class="form-group {{ $errors->has('branch_name') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" placeholder="Enter Branch Name" type="text" name="branch_name" id="branch_name" value="{{ old('branch_name', '') }}" required>
                            ...
                            <div class="form-group {{ $errors->has('branch_address') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" placeholder="Enter Branch Address" type="text" name="branch_address" id="branch_address" value="{{ old('branch_address', '') }}">
