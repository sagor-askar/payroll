            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="form-group">
                            <a class="btn btn-default" href="{{ route('admin.candidate.index') }}">
                                {{ trans('global.back_to_list') }}
                            </a>

                           @if($role_title == 'HR' || $role_title == 'Admin')
                            <div class="form-group" style="float: right">
                                <a  class="btn btn-xs btn-primary" onclick="return approveFunction();" href="{{ route('admin.candidate.createShortlist', $candidates->id) }}">
