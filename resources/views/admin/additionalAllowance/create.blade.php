        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Create Additional Allowance
                </div>
                <div class="panel-body">
                    <form action="{{ route("admin.additional-allowance.store") }}" method="POST" enctype="multiple/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                    <label class="required" for="name">Allowance Name</label>
                                    <input class="form-control" type="text" name="allowance_name" id="name" value="" placeholder="Name" required>
                                    @if($errors->has('name'))
