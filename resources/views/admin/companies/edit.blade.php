                    ...
                    <form method="POST" action="{{ route("admin.companies.update", [$company->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('comp_name') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" name="comp_name" id="comp_name" value="{{ old('comp_name', $company->comp_name) }}" required>
                            ...
                            <div class="form-group {{ $errors->has('comp_address') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" name="comp_address" id="comp_address" value="{{ old('comp_address', $company->comp_address) }}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('contact_no') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="text" name="contact_no" id="contact_no" value="{{ old('contact_no', $company->contact_no) }}">
